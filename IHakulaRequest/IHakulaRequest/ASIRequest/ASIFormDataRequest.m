...
{
	NSString *newString = (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)string, NULL, CFSTR(":/?#[]@!$ &'()*+,;=\"<>%{}|\\^~`"), CFStringConvertNSStringEncodingToEncoding([self stringEncoding])));
	if (newString) {
		return newString;
	}
	return @"";
...
- (id)copyWithZone:(NSZone *)zone
{
	...
	[newRequest setPostData:[[self postData] copyWithZone:zone]];
	[newRequest setFileData:[[self fileData] copyWithZone:zone]];
